export default {
  ...
  settings: {
    ...
    model: {
      ...
      inputWindowPlaceholder: 'Blank = use global default',
      inputWindowHint: 'Leave blank to inherit the global input window. A positive integer overrides this model only.',
      inputWindowConfigured: 'Input window: {count} tokens',
      inputWindowGlobalDefault: 'Input window: global default',
      inputWindowSaved: 'Model input window saved',
      inputWindowSaveFailed: 'Failed to save model input window',
      inputWindowInvalid: 'Input window must be a positive integer, or blank to use the global default',
