export default {
  ...
  settings: {
    ...
    model: {
      ...
      addModel: 'Add Model',
      saveInputWindow: 'Save Window',
      savingInputWindow: 'Saving...',
      inputWindowPlaceholder: 'The system default is prefilled here',
      inputWindowHint: 'This field is prefilled from the system default. Once saved, chat and runtime use the model\'s own input-window value.',
      inputWindowConfigured: 'Input window: {count} tokens',
      inputWindowGlobalDefault: 'Input window: not set, prefill default {count} tokens',
      inputWindowSaved: 'Model input window saved',
      inputWindowSaveFailed: 'Failed to save model input window',
      inputWindowInvalid: 'Input window must be a positive integer',
      inputWindowUnsupported: 'This model is missing an editable config ID, so its input window cannot be saved yet',
      embedding: {
      ...
      modelParamsLoading: 'Loading model parameters...',
      saveModelParams: 'Save Parameters',
      savingModelParams: 'Saving...',
      modelParamsSaved: 'Model parameters saved',
      modelParamsSaveFailed: 'Failed to save model parameters',
      modelParamsUnsupported: 'This model does not support parameter editing',
      modelParamsNameRequired: 'Model display name is required',
      modelParamsNumberInvalid: '{field} must be a number',
      modelParamsIntegerInvalid: '{field} must be an integer greater than 0',
      ...
      fields: {
        ...
        maxInputTokens: 'Input Window (Tokens)',
      },
      actions: {
    ...
    fields: {
      ...
      defaultMaxInputTokens: 'System Default Input Window',
    ...
    hints: {
      ...
      defaultMaxInputTokens: 'Used only to prefill model input windows in Settings. Chat and runtime still use each model\'s own saved value.',
  ...
  skills: {
    ...
    import: {
      ...
      slugLabel: 'Slug',
      sourceLabel: 'Source',
      sameNameFlag: 'Name conflict',
      sameNameWarning: 'Duplicate skill name detected. Verify the author, slug, stats, and source URL before installing.',
