export default {
  ...
  settings: {
    ...
    model: {
      ...
      inputWindowPlaceholder: '留空则使用全局默认',
      inputWindowHint: '留空表示沿用系统默认输入窗口；填写正整数后仅覆盖当前模型。',
      inputWindowConfigured: '输入窗口：{count} tokens',
      inputWindowGlobalDefault: '输入窗口：全局默认',
      inputWindowSaved: '模型输入窗口已保存',
      inputWindowSaveFailed: '模型输入窗口保存失败',
      inputWindowInvalid: '输入窗口必须是大于 0 的整数，或留空使用全局默认',
